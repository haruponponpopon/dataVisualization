...
function MakeGraph(data, id) {
    ...
    function draw() {
        ...
        svg.append("rect").attr("x", 0).attr("y", 0).attr("width", graph_width).attr("height", graph_height).style("fill", "rgb(45, 52, 73)");
    ...
    // add title.
    d3.select("#" + id).append("h3").style("letter-spacing", "0.3em").style("text-decoration", "underline").text("全国の店舗数推移");
