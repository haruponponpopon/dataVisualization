...
#ジャンル
f_w.write("genre: [")
genres = ['コーヒー', 'カフェ', '寿司', 'ハンバーガー', 'カレー', 'ドーナツ', 'タピオカ', 'お好み焼き', '居酒屋', 'からあげ', 'イタリアン', 'ダイニングバー', 'たこ焼き', 'パン', 'ケーキ', 'パンケーキ', 'うなぎ', 'オムライス', 'バー', '洋食', 'パスタ', '喫茶店', '鉄板焼き', 'おでん', 'たい焼き・大判焼き', 'サンドイッチ', '焼きそば', 'ジュースバー', '定食・食堂', 'フレンチ', 'コーヒー専門店', 'ステーキ', '紅茶専門店', '弁当', 'バル・バール', 'ビストロ', 'もんじゃ焼き', '焼鳥', 'ピザ', 'パフェ', 'バイキング', '中国茶専門店', 'ラーメン', 'ワインバー', '自然食', 'ハワイ料理', '野菜料理', 'アイスクリーム', '魚介料理・海鮮料理', 'ハンバーグ']
