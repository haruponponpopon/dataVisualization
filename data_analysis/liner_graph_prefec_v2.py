...
#ジャンル
f_w.write("genre: [")
genres = ['コーヒー', 'カフェ', '寿司', 'ハンバーガー', 'カレー', 'ドーナツ', 'タピオカ', 'お好み焼き', 'イタリアン', 'ダイニングバー', '居酒屋', 'たこ焼き', 'パン', 'ケーキ', 'パンケーキ', 'うなぎ', 'オムライス', 'バー', '洋食', 'パスタ', '喫茶店', 'その他', '鉄板焼き', 'おでん', 'たい焼き・大判焼き', 'サンドイッチ', '焼きそば', 'ジュースバー', 'フレンチ', 'コーヒー専門店', 'ステーキ', '定食・食堂', '紅茶専門店', 'ビストロ', 'カレーライス', 'バル・バール', 'もんじゃ焼き', 'ピザ', 'パフェ', 'バイキング', '焼鳥', '中国茶専門店', 'ワインバー', '自然食', 'ハワイ料理', '野菜料理', 'ラーメン', 'アイスクリーム', '魚介料理・海鮮料理', 'ハンバーグ', '創作料理']
